            ...
            <div className="max-w-4xl mx-auto">
                ...
                {!selectedRole ? (
                    <div className="grid md:grid-cols-2 gap-6">
                        <Card
                            className="p-8 text-center hover:border-accent transition-all"
                        >
                            <div className="inline-flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-accent/10">
                                <User size={32} className="text-accent" />
                            </div>
                            <h2 className="text-2xl font-bold mb-2 text-foreground">I'm a Client</h2>
                            <p className="text-muted-foreground mb-6">
                                Looking for legal assistance and expert lawyers
                            </p>
                        ...
                        <Card
                            className="p-8 text-center hover:border-primary transition-all"
                        >
                            <div className="inline-flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-primary/10">
                                <Scale size={32} className="text-primary" />
                            </div>
                            <h2 className="text-2xl font-bold mb-2 text-foreground">I'm a Lawyer</h2>
                            <p className="text-muted-foreground mb-6">
                                Ready to offer legal services and grow my practice
                            </p>
                            <div className="space-y-3">
                                <Button
                                    variant="outline"
                    ...
                    <Card className="p-8 max-w-2xl mx-auto">
                        <div className="mb-6 flex items-center justify-between">
                            <h2 className="text-2xl font-bold text-foreground">
                                {selectedRole === 'CLIENT' ? 'Client' : 'Lawyer'} Registration
                            </h2>
                            <button
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full px-4 py-3 border border-input rounded-md focus:outline-none focus:ring-2 focus:ring-ring bg-background text-foreground"
                                />
                            </div>
                            ...
                            <div className="flex items-center gap-2">
                                <input type="checkbox" id="terms" required className="w-4 h-4 rounded border-input" />
